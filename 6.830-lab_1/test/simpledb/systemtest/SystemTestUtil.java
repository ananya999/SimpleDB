...
import simpledb.file.HeapFileEncoder;
...
public class SystemTestUtil {
    ...
    public static void matchTuples(DbFile f, TransactionId tid, List<ArrayList<Integer>> expectedTuples)
            throws DbException, TransactionAbortedException, IOException 
    {
        SeqScan scan = new SeqScan(tid, f.getId(), "");
        matchTuples(scan, expectedTuples);
    }

    public static void matchTuples(DbIterator iterator, List<ArrayList<Integer>> expectedTuples)
            throws DbException, TransactionAbortedException, IOException {
        ArrayList<ArrayList<Integer>> expectedTuplesCopy = new ArrayList<ArrayList<Integer>>(expectedTuples);

        if (Debug.isEnabled()) 
        {
            Debug.log("Expected tuples:");
            for (ArrayList<Integer> t : expectedTuplesCopy) {
        ...
        while (iterator.hasNext()) 
        {
            ...
            boolean isExpected = expectedTuplesCopy.remove(list);
